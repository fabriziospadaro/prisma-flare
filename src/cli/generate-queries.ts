...
export function generateQueries() {
  ...
  // Reserved for future provider-specific handling
  ...
  models.forEach(model => {
    ...
    // Always use prisma-flare/client for FlareBuilder - it re-exports from prisma-flare-generated
    // with proper types for the user's Prisma configuration
