/**
 * Transactions Integration Tests - prisma-client Provider
 *
 * Verifies transactions work correctly with new prisma-client provider
 */
...
describe('Transactions - prisma-client Provider', () => {
  beforeEach(async () => {
    await cleanDatabase();
    resetCounters();
  });
