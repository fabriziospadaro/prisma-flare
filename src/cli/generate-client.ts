...
export function generateClient() {
  ...
  //
  // For .ts files, we use 'as any' to prevent TypeScript from inferring types.
  // For .js files, we just use plain assignment (no TypeScript syntax).
  const flareBuilderExport = isNewProvider
    ? `export const FlareBuilder = _FlareBuilder as any;`
