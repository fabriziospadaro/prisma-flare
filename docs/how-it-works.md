...
When you use a custom output path (e.g., `output = "./generated/client"`), prisma-flare generates a `prisma-flare-generated` module in `node_modules` that:
...
Your model classes import from `prisma-flare-generated` to get proper types:

```typescript
// prisma/models/User.ts (auto-generated)
import { FlareBuilder } from 'prisma-flare-generated';
...
2. Also generating `prisma-flare-generated` module for model class imports
3. Using extensionless imports (`./client`) for broad TypeScript compatibility
