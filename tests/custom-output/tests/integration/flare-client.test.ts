/**
 * FlareClient Integration Tests - Custom Output Path
 *
 * Tests FlareClient-specific functionality with custom Prisma output path.
...
describe('FlareClient - Custom Output Path', () => {
  beforeEach(async () => {
    await cleanDatabase();
    resetCounters();
  });
