/**
 * Type Safety Tests for .include() with prisma-client-js Provider
 *
 ...
 *
 * With the default prisma-client-js provider, these should PASS.
 * This serves as a regression test to ensure any fixes don't break
...
import { createUser, createUserWithPosts, resetCounter } from '../helpers/factories.js';

describe('Include Type Safety - prisma-client-js Provider', () => {
  beforeEach(async () => {
    await cleanDatabase();
    resetCounter();
  });
